...
from torch.nn import (AvgPool2d, BatchNorm1d, BatchNorm2d, Conv2d, Linear,
...
class BasicBlock(Module):
    ...
    def forward(self, forward_input):
        residual = forward_input

        out = self.conv1(forward_input)
        out = self.bn1(out)
        out = self.relu(out)
        ...
        if self.downsample is not None:
            residual = self.downsample(forward_input)
